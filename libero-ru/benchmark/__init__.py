...
for libero_suite in libero_suites:
    ...
    print("NUM TASKS ", libero_suite, len(libero_task_map[libero_suite]))
...
@register_benchmark
class RU_LIBERO_SPATIAL(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "ru_libero_spatial"
        self._make_benchmark()
...
@register_benchmark
class RU_LIBERO_OBJECT(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "ru_libero_object"
        self._make_benchmark()
...
@register_benchmark
class RU_LIBERO_GOAL(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "ru_libero_goal"
        self._make_benchmark()
...
@register_benchmark
class RU_LIBERO_10(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "ru_libero_10"
        self._make_benchmark()
